...
const BydgoszczPostsPage = () => {
        ...
        const fetchData = async () => {
            ...
            try {
                const response = await fetch(
                    `https://weckwerthblog.wordpress.com/wp-json/wp/v2/categories?slug=${categorySlug}`
                );
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const response = await fetch(
                    `https://weckwerthblog.wordpress.com/wp-json/wp/v2/posts?_embed&per_page=${postsPerPage}&page=${page}&categories=${currentCategorySlug}`
                );
