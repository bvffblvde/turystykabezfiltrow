...
const PostList = () => {
        ...
        const fetchData = async () => {
            ...
            try {
                const response = await fetch(
                    `https://fundacjanadrzeka.com/wp-json/wp/v2/posts?_embed&per_page=${postsPerPage}&page=${page}`
                );
    ...
    const handleChangePage = (event, newPage) => {
        navigate(`/aktualnosci?page=${newPage}`);
    ...
    return (
        <SectionWrapper id="actual" paddingBottom="100px" paddingTop="20px">
            ...
            <Pagination
                ...
                boundaryCount={window.innerWidth < 600 ? 1 : 2} // Устанавливаем разное количество отображаемых кнопок в зависимости от ширины экрана
                shape="rounded" // Квадратные кнопки
            />

            {/* Backdrop для отображения загрузки */}
